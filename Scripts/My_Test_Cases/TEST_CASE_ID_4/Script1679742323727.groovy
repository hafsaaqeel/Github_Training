...
WebUI.click(findTestObject('Object Repository/Page_Test Login  Practice Test Automation/a_Home'))
WebUI.click(findTestObject('Object Repository/Page_Practice Test Automation  Learn Selenium WebDriver/a_Practice'))
WebUI.click(findTestObject('Object Repository/Page_Practice  Practice Test Automation/a_Test Login Page'))
...
WebUI.click(findTestObject('Object Repository/Page_Logged In Successfully  Practice Test Automation/a_Log out'))
WebUI.closeBrowser()
